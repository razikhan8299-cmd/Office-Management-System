<%-- 
    ...
    Created on : 4 Mar, 2024, 5:39:43 PM
    Author     : RAZI KHAN
--%>
...
<%
    ...
    if(db.rst.next())
    {
                ...
                out.println("<tr><td width='300'>Adderess</td><td>"+db.rst.getString(6)+"></td></tr>");
                out.println("<tr><td width='300'>City</td><td>"+db.rst.getString(7)+"></td></tr>");
                out.println("<tr><td width='300'>Contect</td><td>"+db.rst.getString(8)+"></td></tr>");
